  ...
  <div class="box">
    ...
    <div class="box">
        ...
        <el-form>
            <div class="contet">
                                ...
                                <div class="testContent" v-if="params.questions.length > 0">
                                    <div class="dan" v-if="form.isChoce == true">
                                        ...
                                        <p style="margin-left: 10px;">每题
                                            <el-input placeholder="" size="small" clearable 
                                    ...
                                    <div class="gotContent" v-for="(item, index) in params.questions" :key="index">
                                        <div class="gottop">
                                            <div class="gotleft">
                                                ...
                                                <el-input placeholder="" size="normal" clearable 
                ...
                <div class="examset">
                    <el-form :model="params" label-width="120px">
                        ...
                        <el-form-item label="开放时间" style="width: 800px;">
                            <el-date-picker v-model="opTime" type="datetimerange" :shortcuts="shortcuts"
                                range-separator="To" format="YYYY-MM-DD HH:mm" value-format="YYYY-MM-DD HH:mm"
                                start-placeholder="Start date" end-placeholder="End date" @change="getTime" />
                ...
                <div class="showTeacher">
                    <span>可见老师:</span>
                    <el-button type="defalu" size="default" @click="dialogTeacher = true">+选择</el-button>
                    <div class="leng">
                ...
                <div class="showTeacher">
                    <span>考生范围：</span>
                    <el-button type="defalu" size="default" @click="dialogStudent=true">+选择</el-button>
                    <div class="leng">
                ...
                <div class="showTeacher">
                    <span>阅卷老师:</span>
                    <el-button type="defalu" size="default" @click="dialogyueTeacher = true">+选择</el-button>
                    <div class="leng">
        ...
        <el-dialog title="可见老师" v-model="dialogTeacher" v-if="dialogTeacher" width="50%">
            <Forth v-model="dialogTeacher" @limitss="limitss" @sub="sub" @valuesss="valuesss"></Forth>
        </el-dialog>
        <!-- 学生范围 -->
        ...
        <!-- 阅卷老师 -->
        <el-dialog title="阅卷老师" v-model="dialogyueTeacher" v-show="dialogyueTeacher" width="50%">
